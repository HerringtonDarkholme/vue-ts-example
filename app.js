...
/***/ function(module, exports, __webpack_require__) {
	...
	var av_ts_1 = __webpack_require__(5);
	var kilimanjaro_1 = __webpack_require__(15);
	var store = kilimanjaro_1.create({ count: 0 })
	    .getter('count', function (s) { return s.count; })
	    .mutation('increment', function (s) { return function () { return s.count++; }; })
	    .mutation('decrement', function (s) { return function () {
	    if (s.count <= 0) {
	        alert('Start from 0');
	        return;
	    }
	    ...
	    .done();
	var _a = kilimanjaro_1.getHelper(store), getters = _a.getters, commit = _a.commit;
	var App = (function (_super) {
	    __extends(App, _super);
	    function App() {
	        _super.apply(this, arguments);
	        this.name = 'Rem';
	        this.i = getters('count');
	        this.add = commit('increment');
	        this.sub = commit('decrement');
	    }
	    ...
	    __decorate([
	        kilimanjaro_1.Vuex
	    ], App.prototype, "i", void 0);
	    __decorate([
	        kilimanjaro_1.Vuex
	    ], App.prototype, "add", void 0);
	    __decorate([
	        kilimanjaro_1.Vuex
	    ], App.prototype, "sub", void 0);
	    App = __decorate([
	        av_ts_1.Component
	    ], App);
	    return App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lifecycle_1 = __webpack_require__(8);
	...
	var functional_1 = __webpack_require__(14);
	exports.functional = functional_1.functional;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function makeOptionsFromMeta(meta) {
	    var options = meta;
	    options.props = {};
	    options.computed = {};
	    options.watch = {};
	...
	function collectData(instance, optionsToWrite) {
	    ...
	    optionsToWrite.data = function () {
	        return util_1.snapshot(selfData);
	    };
	}
	...
	function Component_(meta) {
	    ...
	    function decorate(cls) {
	        ...
	        var options = makeOptionsFromMeta(meta);
...
/***/ function(module, exports, __webpack_require__) {
	...
	core_1.Component.register(LIFECYCLE_KEY, function (proto, instance, options) {
	    ...
	    for (var lifecycle in lifecycles) {
	        ...
	        var handler = proto[lifecycle] || options.methods[lifecycle];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Watch(func, option) {
	    return function (target, key) {
	        var watchedProps = target[WATCH_PROP] = target[WATCH_PROP] || {};
	        if (!option) {
...
/***/ function(module, exports) {
	...
	"use strict";
	function functional(render, _props) {
	    ...
	    var props = _props;
	    return {
	        props: props, render: render, functional: true
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var decorator_1 = __webpack_require__(16);
	exports.Vuex = decorator_1.Vuex;
	exports.getHelper = decorator_1.getHelper;
	var opt_1 = __webpack_require__(17);
	exports.create = opt_1.create;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var av_ts_1 = __webpack_require__(5);
	var VUEX_PROP = '$$Vuex';
	var GetterKey = '__isgetter';
	function Vuex(target, key) {
	    var vuexProps = target[VUEX_PROP] = target[VUEX_PROP] || [];
	    vuexProps.push(key);
	}
	exports.Vuex = Vuex;
	...
	function getHelper(store) {
	    if (store._helper)
	        return store._helper;
	    var impl = store;
	    var commit = store.commit, dispatch = store.dispatch;
	    return impl._helper = {
	        getters: function (k) {
	            var getter = impl._getters[k];
	            getter[GetterKey] = true; // a flag to distinguish between methods and computed
	            return getter;
	        },
	        commit: memoize(function (k) { return function () {
	            var args = [];
	            for (var _i = 0; _i < arguments.length; _i++) {
	                args[_i - 0] = arguments[_i];
	            }
	            return commit.apply(null, [k].concat(args));
	        }; }),
	        dispatch: memoize(function (k) { return function () {
	            var args = [];
	            for (var _i = 0; _i < arguments.length; _i++) {
	                args[_i - 0] = arguments[_i];
	            }
	            return dispatch.apply(null, [k].concat(args));
	        }; }),
	    };
	}
	exports.getHelper = getHelper;
	av_ts_1.Component.register(VUEX_PROP, function (target, instance, optionsToWrite) {
	    var vuexProps = target[VUEX_PROP];
	    for (var _i = 0, vuexProps_1 = vuexProps; _i < vuexProps_1.length; _i++) {
	        var key = vuexProps_1[_i];
	        var handler = instance[key];
	...
	function memoize(func) {
	    ...
	    memoized['cache'] = util_1.createMap();
	    return memoized;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util_1 = __webpack_require__(7);
	var m = util_1.createMap;
	/** @internal */
	var OptImpl = (function () {
	    function OptImpl(s) {
	        this._getters = m();
	        this._actions = m();
	        this._mutations = m();
	    ...
	    OptImpl.prototype.getter = function (key, f) {
	        this._getters[key] = f;
	        return this;
	    };
	    OptImpl.prototype.declareGetter = function () { return this; };
	    OptImpl.prototype.mutation = function (key, f) {
	        this._mutations[key] = f;
	        return this;
	    };
	    OptImpl.prototype.declareMutation = function () { return this; };
	    OptImpl.prototype.action = function (key, f) {
	        this._actions[key] = f;
	        return this;
	    };
	    OptImpl.prototype.declareAction = function () { return this; };
	    OptImpl.prototype.module = function (key, o) {
	        this._modules[key] = o;
	        return this;
	    };
	    OptImpl.prototype.plugin = function () {
	        var plugins = [];
	        for (var _i = 0; _i < arguments.length; _i++) {
	    ...
	    OptImpl.prototype.done = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var devtool_1 = __webpack_require__(20);
	var Vue = __webpack_require__(1);
	var util_1 = __webpack_require__(7);
	var dispatchImpl = function (store) { return function (type, payload) {
	    var handlers = store._actions[type];
	    if (!handlers) {
	        console.error("unknown action type: " + type);
	        return null;
	    }
	    return Promise.all(handlers.map(function (h) { return h(payload); })).catch(function (err) {
	        store._devtoolHook && store._devtoolHook.emit('vuex:error', err);
	        throw err;
	    });
	}; };
	var commitImpl = function (store) { return function (type, payload, opt) {
	    var mutation = { type: type, payload: payload };
	    var handlers = store._mutations[type];
	    if (!handlers) {
	        console.error("unknown action type: " + type);
	        return;
	    }
	    handlers.forEach(function (h) { return h(payload); });
	    if (!opt || !opt.silent) {
	        store._subscribers.forEach(function (s) { return s(mutation, store.state); });
	    }
	}; };
	var getterImpl = function (store) { return function (key) { return store._vm[key]; }; };
	/** @internal */
	var StoreImpl = (function () {
	    /** @internal */ function StoreImpl(opt) {
	        var _this = this;
	        this._getters = util_1.createMap();
	        this._mutations = util_1.createMap();
	        this._actions = util_1.createMap();
	        this._subscribers = [];
	        this.dispatch = dispatchImpl(this);
	        this.commit = commitImpl(this);
	        this.getters = getterImpl(this);
	        this._watcherVM = new Vue();
	        var state = new state_1.default(opt._state);
	        installModules(this, opt, state);
	        initVM(this, state);
	        opt._plugins.concat(devtool_1.default).forEach(function (p) { return p(_this); });
	    }
	    Object.defineProperty(StoreImpl.prototype, "state", {
	        get: function () {
	    ...
	    StoreImpl.prototype.watch = function (getter, cb, options) {
	        var _this = this;
	        return this._watcherVM.$watch(function () { return getter(_this.state); }, cb, options);
	    };
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	/** @internal */
	exports.default = StoreImpl;
	function installModules(store, opt, state) {
	    var modules = opt._modules;
	    for (var key in modules) {
	        var moduleOpt = modules[key];
	        var subState = state.avtsModuleState[key] = new state_1.default(moduleOpt._state);
	...
	function registerGetters(store, getters, state) {
	    var _loop_1 = function (key) {
	        store._getters[key] = function () { return getters[key](state, store.getters); };
	    };
	    for (var key in getters) {
	        _loop_1(key);
	    }
	}
	function registerMutations(store, mutations, state) {
	    var _mutations = store._mutations;
	    for (var key in mutations) {
	        _mutations[key] = _mutations[key] || [];
	        var mutation = mutations[key](state);
	        _mutations[key].push(mutation);
	    }
	}
	function registerActions(store, actions, state) {
	    var _actions = store._actions;
...
/***/ function(module, exports) {
	...
	var State = (function () {
	    function State(s) {
	        /** @internal */ this.avtsModuleState = {};
	        for (var _i = 0, _a = Object.keys(s); _i < _a.length; _i++) {
	            var key = _a[_i];
	            this[key] = s[key];
	        }
	    }
	    State.prototype.$ = function (key) {
